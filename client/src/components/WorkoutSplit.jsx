...
const splitsData = [
  ...
  },
  {
    ...
    description: 'Balanced split ideal for strength and hypertrophy.',
    days: [
  ...
  },
  {
    id: 5,
    title: 'Arnold Split',
    description: 'High-volume split popularized by Arnold Schwarzenegger.',
    days: [
  ...
  },
  {
    id: 7,
    title: 'PHAT Split',
    description: 'Advanced split blending powerlifting and bodybuilding.',
    days: [
      { day: 'Day 1', muscles: 'Upper Power' },
      { day: 'Day 2', muscles: 'Lower Power' },
  ...
  },
  {
    ...
    description: 'Lower-body focused split for toning and strength.',
    days: [
  ...
  },
  {
    ...
    description: 'High-frequency training combined with cardio for fat loss.',
    days: [
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="text-center pt-10 px-4">
        <h1 className="text-3xl font-bold text-slate-900">Workout Splits</h1>
        <p className="mt-2 text-slate-600 max-w-xl mx-auto">
          Choose a workout split that matches your goals, schedule, and training
          style
        </p>
      </div>
