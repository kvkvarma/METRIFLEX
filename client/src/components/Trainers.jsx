...
const Trainers = () => {
  ...
  const addRequest = async (e) => {
    ...
    try {
      const res = await axios.post(`${API}/trainer/addrequest`, payLoad);
  ...
  if (!detailsPopup) {
    return (
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {trainers.map((item) => (
            <div
              key={item.trainerId}
